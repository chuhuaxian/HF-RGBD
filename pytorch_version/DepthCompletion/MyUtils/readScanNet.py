...
# data paths
parser.add_argument('--filename',  default='F:\\Datasets\\scans\\scene0000_00\\scene0000_00.sens', required=False, help='path to sens file to read')
parser.add_argument('--output_path', default='F:\\Datasets\\scan_data\\scene_00', required=False, help='path to output folder')
...
parser.set_defaults(export_depth_images=True, export_color_images=True, export_poses=False, export_intrinsics=False)
